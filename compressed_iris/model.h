...
const float dense1[4][10] = {{0.6687432 , -0.61946446,  0.3925613 , -0.6256361 , -0.15233004, -0.25770617, -0.22145933, -0.03116034, -0.07213708,  0.08552536},
...
const float bias1[10] = {0.24006544, 0., 0.16063713, 0., 0., 0., 0., 0.2148306 , -0.0584112 , 0.2479922};

const float dense2[10][10] = {{-0.29739213, -0.22500926, -0.10855037,  0.7298434 , -0.53956246, -0.5398267 , -0.01083072, -0.26863214,  0.01156667, -0.18011901},
...
const float bias2[10] = {0.22483708, 0.,  0., 0.05908684, 0., -0.13067733, 0.09735662, -0.08622272, 0.18277514, -0.01721832};

const float dense3[10][3] = {{-1.05251837e+00,  2.67649651e-01,  6.58927143e-01},
...
const float bias3[3] = {0.08492658, 0.08103085, -0.2379903};


int predict(float m1, float m2, float m3, float m4){
